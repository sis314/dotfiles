...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'lualine.nvim', 'toggleterm.nvim', 'vim-repeat', 'vim-sandwich', 'alpha-nvim', 'vim-surround'}, { event = "BufEnter *" }, _G.packer_plugins)]]
